...
public class RestUserDataClient implements UserDataClient {
    ...
    List<UserJson> allUsers(@Nonnull String username) {
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        params.add("username", username);
        URI uri = UriComponentsBuilder.fromHttpUrl(rococoUserdataBaseUri + "/allUsers").queryParams(params).build().toUri();
    ...
    List<UserJson> friends(@Nonnull String username, boolean includePending) {
        ...
        URI uri = UriComponentsBuilder.fromHttpUrl(rococoUserdataBaseUri + "/friends").queryParams(params).build().toUri();
    ...
    List<UserJson> invitations(@Nonnull String username) {
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        params.add("username", username);
        URI uri = UriComponentsBuilder.fromHttpUrl(rococoUserdataBaseUri + "/invitations").queryParams(params).build().toUri();
    ...
    List<UserJson> acceptInvitation(@Nonnull String username,
        ...
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        params.add("username", username);
        URI uri = UriComponentsBuilder.fromHttpUrl(rococoUserdataBaseUri + "/acceptInvitation").queryParams(params).build().toUri();
    ...
    List<UserJson> declineInvitation(@Nonnull String username,
        ...
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        params.add("username", username);
        URI uri = UriComponentsBuilder.fromHttpUrl(rococoUserdataBaseUri + "/declineInvitation").queryParams(params).build().toUri();
    ...
    public @Nonnull UserJson addFriend(@Nonnull String username,
        ...
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        params.add("username", username);
        URI uri = UriComponentsBuilder.fromHttpUrl(rococoUserdataBaseUri + "/addFriend").queryParams(params).build().toUri();
    ...
    List<UserJson> removeFriend(@Nonnull String username,
        ...
        URI uri = UriComponentsBuilder.fromHttpUrl(rococoUserdataBaseUri + "/removeFriend").queryParams(params).build().toUri();
